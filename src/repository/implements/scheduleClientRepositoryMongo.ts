import { IScheduleClient, ScheduleClientRepository } from '../scheduleClientRepository';
import { ScheduleClient } from '../../models/scheduleClientModel';

class ScheduleClientRepositoryMongo implements ScheduleClientRepository {
    async newSchedule({ id_user, name, date, time, service, phone }: IScheduleClient): Promise<void> {
