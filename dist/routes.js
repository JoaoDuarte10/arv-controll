...
router.post('/new-client', (req, res) => {
    return index_1.clientController.newClient(req, res);
});
router.post('/update-client', (req, res) => {
    return index_1.clientController.updateClient(req, res);
});
router.post('/find-all-client', (req, res) => {
    return index_1.clientController.findAllClients(req, res);
});
router.post('/find-client', (req, res) => {
    return index_1.clientController.findClient(req, res);
});
router.post('/delete-client', (req, res) => {
    return index_1.clientController.deleteClient(req, res);
});
